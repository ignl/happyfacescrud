...
public class DefaultRepositoryFactory extends JpaRepositoryFactory {
	...
	/**
	 * @see org.springframework.data.jpa.repository.support.JpaRepositoryFactory${symbol_pound}getTargetRepository(org.springframework.data.repository.core.RepositoryMetadata,
	...
	/**
	 * @see org.springframework.data.jpa.repository.support.JpaRepositoryFactory${symbol_pound}getRepositoryBaseClass(org.springframework.data.repository.core.RepositoryMetadata)
	 */
	@Override
