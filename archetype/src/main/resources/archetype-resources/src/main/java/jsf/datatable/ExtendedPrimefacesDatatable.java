 ...
 * 
 */
// TODO primefaces 5.0 should accept EL as sort by, but for some reason it doesn't work in column.xhtml if I try ${symbol_pound}{entity[field]}
